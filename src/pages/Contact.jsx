                ...
                <div className='flex md:flex-row flex-col text-white mt-10 gap-10 px-3'>
                    <div className='md:w-1/2 '>
                        ...
                        <div className='flex items-center gap-4 mb-4'>
                            <div
                                style={{
                                    background: 'linear-gradient(90deg, rgba(78,33,207,1) 0%, rgba(78,159,215,1) 90%)',
                                }}
                    ...
                    <div className='md:w-1/2'>
                        ...
                        <div
                            ...
                            style={{
                                background: 'linear-gradient(90deg, rgba(78,159,215,1) 0%, rgba(8,97,158,1) 90%)',
                            }}
                        >
                            <form action="" className='flex-col flex gap-5'>
                                <input type="text"
                                    placeholder='name'
                                    className='bg-slate-900 text-gray-300 py-6 px-5 rounded-lg'
                                />
                                <input type="email"
                                    placeholder='Email'
                                    className='bg-slate-900 text-gray-300 py-6 px-5 rounded-lg'
                                ...
                                <textarea
                                    ...
                                    id="message"
                                    className='bg-slate-900 text-gray-300 py-6 px-5 rounded-lg'
                                    style={{ width: '100%', height: '150px' }} // Fixed width and height for textarea
                                ></textarea>
                                <button className='w-[40%] bg-slate-900 py-3 rounded-lg text-gray-300'>
                                    submit
                                </button>
                            </form>
                        </div>
